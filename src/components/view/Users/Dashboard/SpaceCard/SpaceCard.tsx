...
import CreateBookingModal from "../CreateBookingModal.tsx/CreateBookingModal";
							...
							>
								<CardContent className="p-4">
									...
									<Button
										...
										className="mt-5 h-10 w-full rounded-full bg-blue-600 text-sm font-medium hover:bg-blue-700"
									>
										Book Now
